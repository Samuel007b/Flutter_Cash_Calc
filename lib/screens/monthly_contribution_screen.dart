...
class _MonthlyContributionScreenState extends State<MonthlyContributionScreen>{
  ...
  void _calculateMonthlyContribution(double amount, double initialCapital, double interestRate, int period){
    if(amount==0){
      ...
      if(interestRate==0){
        monthlyContribution=(amount-initialCapital)/period;
      }
      else{
        monthlyContribution=(interestRate*(amount-initialCapital*pow((1+interestRate),period)))/(pow((1+interestRate),period)-1);
      }
      ...
      setState(() {
        result="Aporte Mensal: R\$ ${fa.getMonthlyContribution().toStringAsFixed(2).replaceAll('.', ',')}";
        ...
        body: SingleChildScrollView(
          ...
          child: Padding(
            ...
            children: [
              ...
              Center(
                child: Image.asset('assets/monthlyIcon.png', width: 150,),
              ),
